<?php /* Smarty version Smarty-3.1.18, created on 2018-05-09 22:10:08
         compiled from "C:\xampp\htdocs\Catalogo-PHP-master\application\views\foot.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13905af355a01873c2-70012334%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8959cbd660647c27b6626c666e8907096a8cf929' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Catalogo-PHP-master\\application\\views\\foot.tpl',
      1 => 1401920406,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13905af355a01873c2-70012334',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5af355a01c4ef0_60893552',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5af355a01c4ef0_60893552')) {function content_5af355a01c4ef0_60893552($_smarty_tpl) {?>                <h4 class="title">Recent Works</h4>
                <div class="row featured_items">
                	<div class="col-md-3">
                    	<div class="item">
                        	<div class="img_block hover_img">
                            	<a href="javascript:void(0);">
                                	<img src="<?php echo base_url('images/portfolio/570_400/1.jpg');?>
" alt="" />
                                    <div class="item_fadder"></div>
                                    <div class="link_ico"><i class="fa fa-link"></i></div>
                                </a>
                            </div>                            
                            <div class="items_body">
                                <div class="items_title">
                                    <h5><a href="javascript:void(0);">Cras Vitae Sodales</a></h5>									
                                </div>
                                <div class="items_desc">                                    
                                    <p>Integer at elit in lacus hendrerit vestibulum eget in sapien. Curabitur pulvinar tellus vitae <a href="javascript:void(0);">Read more!</a></p>                      
                                </div>
                            </div>                                                        
                        </div>
                    </div>
                	<div class="col-md-3">
                    	<div class="item">
                        	<div class="img_block hover_img">
                            	<a href="javascript:void(0);">
                                	<img src="<?php echo base_url('images/portfolio/570_400/2.jpg');?>
" alt="" />
                                    <div class="item_fadder"></div>
                                    <div class="link_ico"><i class="fa fa-link"></i></div>
                                </a>
                            ...
                            <div class="items_body">
                                <div class="items_title">
                                    <h5><a href="javascript:void(0);">Tincidunt Pharetra</a></h5>									
                                </div>
                                <div class="items_desc">                                    
                                    <p>Integer at elit in lacus hendrerit vestibulum eget in sapien. Curabitur pulvinar tellus vitae <a href="javascript:void(0);">Read more!</a></p>                      
                                </div>
                    ...
                    <div class="col-md-3">
                    	<div class="item">
                        	<div class="img_block hover_img">
                            	<a href="javascript:void(0);">
                                	<img src="<?php echo base_url('images/portfolio/570_400/3.jpg');?>
" alt="" />
                                    <div class="item_fadder"></div>
                                    <div class="link_ico"><i class="fa fa-link"></i></div>
                                </a>
                            ...
                            <div class="items_body">
                                <div class="items_title">
                                    <h5><a href="javascript:void(0);">Sit Amet Egestas</a></h5>									
                                </div>
                                <div class="items_desc">                                    
                                    <p>Integer at elit in lacus hendrerit vestibulum eget in sapien. Curabitur pulvinar tellus vitae <a href="javascript:void(0);">Read more!</a></p>                      
                                </div>
                    ...
                    <div class="col-md-3">
                    	<div class="item">
                        	<div class="img_block hover_img">
                            	<a href="javascript:void(0);">
                                	<img src="<?php echo base_url('images/portfolio/570_400/4.jpg');?>
" alt="" />
                                    <div class="item_fadder"></div>
                                    <div class="link_ico"><i class="fa fa-link"></i></div>
                                </a>
                            ...
                            <div class="items_body">
                                <div class="items_title">
                                    <h5><a href="javascript:void(0);">Ridiculus Nec Egestas</a></h5>									
                                </div>
                                <div class="items_desc">                                    
                                    <p>Integer at elit in lacus hendrerit vestibulum eget in sapien. Curabitur pulvinar tellus vitae <a href="javascript:void(0);">Read more!</a></p>                      
                                </div>
        ...
        <div class="footer">
        	...
        	<div class="footer_bottom container">            	
                ...
                <div class="clear"></div>
                <div class="copyright">&copy; 2020 Catalog System. All Rights Reserved.</div>
            </div>
        	<!-- //footer_bottom -->
        </div>
        <!--//footer-->        
